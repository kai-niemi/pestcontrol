package io.cockroachdb.pestcontrol.web.api.chart;
...
import io.cockroachdb.pestcontrol.web.front.AbstractSessionController;
...
public class RestChartWorkloadController extends AbstractSessionController {
    @Autowired
