...
public class ClusterController {
    ...
    public ResponseEntity<EntityModel<Cluster>> getCluster(@PathVariable("clusterId") String clusterId) throws IOException {
    ...
    public ResponseEntity<MessageModel> getClusterOperator(@PathVariable("clusterType") ClusterType clusterType) throws IOException {
    ...
    public ResponseEntity<MessageModel> getVersion(@PathVariable("clusterId") String clusterId) {
        Cluster cluster = applicationProperties.getClusterById(clusterId);
