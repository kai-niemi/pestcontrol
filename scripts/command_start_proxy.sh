...
fn_print_info "Add up to ${#locality_zone[@]} node proxies automatically"
fn_local_node_range
...
fn_print_ok "Started toxiproxy server with proxies - you can now start the CockroachDB cluster!"