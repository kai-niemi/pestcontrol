...
# ./cluster-admin agent-kill --listen-addr=localhost:26258
# ./cluster-admin agent-kill --listen-addr=localhost:26259
# ./cluster-admin agent-kill --listen-addr=localhost:26260
